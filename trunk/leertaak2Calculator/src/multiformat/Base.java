...
public abstract class Base
{
	...
	public static final int MAX_PRECISION = 10; // max # of number after point
	...
	/**
	 * Takes the input string and calculates the double value, using the current
	 * numberbase.
	 * 
	 * @param number
	 *            A String representation like "101.101" or "1A3.E56".
	...
	private boolean isValidBaseChar(char baseChar)
	{
		for(int i = 0; i < digits.length(); i++)
		{
			if(digits.charAt(i) == baseChar)
				return true;
		}
		return false;
	}
	...
	String toString(double number)
	{
		...
		// in the current numberbase. I.e. to represent 9 you need four
		// positions ("1001").
