 ...
 * @author Jasper Lankhorst: Added more comments
 * @author Wouter Nijenhuis: Added more comments
 * @version 1
 */
public class Rational
{
	...
	/**
	 * Get rid of any decimals in the numerator. E.g. 12.5/1.0 becomes
	 * 125.0/10.0 (Note that any decimals in the denominator aren't handled, eg
	 * 10/0.5. This seems an omission.) Seen also unittest TestRational.java
	 */
	...
	/**
	 * Simplify the rational. 125/10 becomes 25/2. Seen also unittest
	 * TestRational.java
	 */
	public void simplify()
	{
		...
		{
			double rn = Math.abs(Math.IEEEremainder(Math.abs(numerator), divisor));
			double rd = Math.abs(Math.IEEEremainder(denominator, divisor));
	 ...
	 * 
	 * @param other
	 *            Another Rational to add to this.
	...
	/**
	 * Gets the numerator for this rational
	...
	/**
	 * Gets the denominator for this rational
	...
	/**
	 * Sets the numerator for this rational
	 * @param num
	 *            The new numerator
	 */
	...
	/**
	 * Sets the denominator for this rational
	 * @param den
	 *            The new denominator
	 */
